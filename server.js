...
const upload = multer({storage: storageUpload}).fields([
    ...
    {name : 'gallery_one', maxCount: 1},
    {name : 'gallery_two', maxCount: 1},
    {name : 'gallery_three', maxCount: 1},
])
...
// routes
require("./app/routes/dpc.routes")(app);
require("./app/routes/dpd.routes")(app);
require("./app/routes/member.routes")(app);


app.get('/', (req, res) => res.send('Ready for hpoi'))
